...
@Component({
  selector: 'app-safetydoc-devices',
  templateUrl: './safetydoc-devices.component.html',
  styleUrls: ['./safetydoc-devices.component.css']
})
export class SafetydocDevicesComponent implements OnInit {
  ...
  constructor(private router: Router, private modalService: NgbModal, private safetydocService: SafetydocService, private deviceService: DeviceService){
  }
  ...
  onSave(){
    ...
    this.safetydocService.devicesEmitChange(this.devicesList);
    this.router.navigate(['/safetydocs/new/checklist']);
  }
